...
#define MZ_SILENCED			128		// UNUSED in Transfusion. bit flag ORed with one of the above numbers
...
#define	DF_INSTANT_ITEMS	0x00000010	// 16		// UNUSED. DON'T REMOVE (the engine uses it)
#define	DF_SAME_LEVEL		0x00000020	// 32
#define DF_SKINTEAMS		0x00000040	// 64		// UNUSED. DON'T REMOVE (the engine uses it)
#define DF_MODELTEAMS		0x00000080	// 128		// UNUSED. DON'T REMOVE (the engine uses it)
...
#define DF_QUAD_DROP		0x00004000	// 16384	// UNUSED. DON'T REMOVE (the engine uses it)
