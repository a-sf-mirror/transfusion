...
void W_Wall(TPoint point1, TPoint point2, FILE *f, TWall w)
{
 ...
 if (point1.zt == point1.zb) return; //point1.zb--;
 if (point2.zt == point2.zb) return; //point2.zb--;
...
// w.x_off, w.y_off, w.rot_angle, w.x_scale, w.y_scale, w.content_a, w.surface_a, w.light_v,
 ...
 {
  fprintf(f, " {\n");                                                        
  WriteLine( 0, 0, point1.zt, 0, 500, point1.zt, 500, 0, point2.zt, Texture, w, f); 
  WriteLine( point1.x, point1.y-1+1, point1.zt, point2.x, point2.y-1+1, point2.zt, point2.x, point2.y-1+1, point2.zb, Texture, w, f);
  WriteLine( point2.x, point2.y-1+1, point2.zt, point2.x, point2.y+1, point2.zt, point2.x, point2.y+1, point2.zb, Texture, w, f);
  WriteLine( point2.x, point2.y+1, point2.zt, point1.x, point1.y+1, point1.zt, point1.x, point1.y+1, point1.zb, Texture, w, f);
  WriteLine( point1.x, point1.y+1, point1.zt, point1.x, point1.y-1+1, point1.zt,  point1.x, point1.y-1+1, point1.zb, Texture, w, f);
  WriteLine( 0, 0, point1.zb, 500, 0, point1.zb, 0, 500, point2.zb, Texture, w, f);
  fprintf(f, " }\n");
 }
 ...
 if ((rad >= 45) & (rad <= 135))
 {
  fprintf(f, " {\n");
  WriteLine( 0, 0, point1.zt, 0, 500, point1.zt, 500, 0, point2.zt, Texture, w, f);
  WriteLine( point1.x+1-1, point1.y, point1.zt, point2.x+1-1, point2.y, point2.zt, point2.x+1-1, point2.y, point2.zb, Texture, w, f);
  WriteLine( point2.x+1-1, point2.y, point2.zt, point2.x-1, point2.y, point2.zt, point2.x-1, point2.y, point2.zb, Texture, w, f);  
  WriteLine( point2.x-1, point2.y, point2.zt, point1.x-1,   point1.y, point1.zt, point1.x-1,   point1.y, point1.zb, Texture, w, f);
  WriteLine( point1.x-1,   point1.y, point1.zt, point1.x+1-1, point1.y, point1.zt, point1.x+1-1, point1.y, point1.zb, Texture, w, f);
  WriteLine( 0, 0,     point1.zb, 500, 0,     point1.zb, 0, 500,  point2.zb, Texture, w, f);
  fprintf(f, " }\n");
 }
 ...
 if ((rad > 135) & (rad <= 225))
 {
  ...
  WriteLine( 0, 0, point1.zt, 0,    500, point1.zt, 500,  0,  point2.zt, Texture, w, f);
  WriteLine( point2.x, point2.y-1, point2.zt, point1.x, point1.y-1, point1.zt, point1.x, point1.y-1, point1.zb, Texture, w, f);
  WriteLine( point1.x, point1.y-1, point1.zt, point1.x, point1.y, point1.zt, point1.x, point1.y,   point1.zb, Texture, w, f);
  WriteLine( point1.x, point1.y, point1.zt, point2.x, point2.y,  point2.zt, point2.x, point2.y,   point2.zb, Texture, w, f);
  WriteLine( point2.x, point2.y,  point2.zt, point2.x, point2.y-1, point2.zt, point2.x, point2.y-1, point2.zb, Texture, w, f);
  WriteLine( 0, 0,      point1.zb, 500,  0,      point1.zb, 0,    500,    point2.zb, Texture, w, f);
  fprintf(f, " }\n");
 } 
 ...
 if ((rad > 225) & (rad <= 315))
 {
  ...
  WriteLine( 0, 0, point1.zt, 0,    500, point1.zt, 500,  0,  point2.zt, Texture, w, f);
  WriteLine(  point2.x+1, point2.y, point2.zt, point1.x+1, point1.y, point1.zt,  point1.x+1, point1.y, point1.zb, Texture, w, f);
  WriteLine(  point1.x+1, point1.y, point1.zt, point1.x, point1.y, point1.zt, point1.x, point1.y, point1.zb, Texture, w, f);
  WriteLine(  point1.x, point1.y, point1.zt, point2.x, point2.y, point2.zt, point2.x, point2.y, point2.zb, Texture, w, f);
  WriteLine(  point2.x, point2.y, point2.zt, point2.x+1, point2.y, point2.zt, point2.x+1, point2.y, point2.zb, Texture, w, f);
  WriteLine( 0, 0,      point1.zb, 500,  0,      point1.zb, 0,    500,    point2.zb, Texture, w, f);
  fprintf(f, " }\n");
 }
